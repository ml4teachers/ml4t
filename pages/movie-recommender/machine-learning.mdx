...
<details>
<summary className="cursor-pointer" style={{fontWeight: "bold"}}>A13 – Stelle sicher, dass du 10 Filme aus der Filmliste kennst. Bewerte dann einen Teil davon. Dies sind deine Trainingsdaten. Wie lange musst du dein Modell trainieren?</summary>
